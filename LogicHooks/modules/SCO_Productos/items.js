...
function insertarNuevoProd() {
    ...
    var b3 = x.insertCell(1);
    b3.innerHTML = "<textarea id='pro_descripcion" + pronum + "' name='pro_descripcion" + pronum + "' rows='2' cols='30' style='margin-left: 0px; margin-right: 0px; width: 220px;'></textarea>";
    var b = x.insertCell(2);
