...
$manifest = array (
    ...
    'key'=>'',
    'author' => 'Smackcoders',
    'description' => 'Customize your login pages with different templates',
    'icon' => '',
    'is_uninstallable' => true,
    'name' => 'Login Page Customizer for SuiteCRM',
...
$installdefs = array (
    ...
    'copy' =>
        array (
            array (
                'from' => '<basepath>/SM_CustomLogin',
                'to' => 'modules/SM_CustomLogin',
            ),
			array (
				'from' => '<basepath>/SM_CustomLogin.php',
				'to' => 'custom/modules/SM_CustomLogin.php',
			),
        ),
    'language' =>
        array (
            array(
                'from'=> '<basepath>/SM_CustomLogin_admin/language/en_us.SM_CustomLogin.php',
    ...
    'administration' =>
        array(
            array(
                'from'=>'<basepath>/SM_CustomLogin_admin/menu/SM_CustomLogin_admin.php',
                'to' => 'modules/Administration/SM_CustomLogin_admin.php',
            ),
        ),
    'action_view_map' =>
        array (
            array(
                'from'=> '<basepath>/SM_CustomLogin_admin/actionviewmap/SM_CustomLogin_actionviewmap.php',
                'to_module'=> 'SM_CustomLogin',
            ),
        ),
    'logic_hooks' => array(
       array(
          'hook' => 'after_ui_frame',
          'order' => 1,
          'description' => 'SuiteCRM Custom Login',
          'file' => 'custom/modules/SM_CustomLogin.php',
          'class' => 'SM_CustomLogin',
          'function' => 'sm_custom_login',
       ),
