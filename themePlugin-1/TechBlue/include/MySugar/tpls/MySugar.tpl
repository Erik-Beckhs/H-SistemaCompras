...
<div class="dashboard">
    ...
    <ul class="nav nav-tabs nav-dashboard">
        ...
        {if !$lock_homepage}
            <li id="tab-actions" class="dropdown">
                ...
                {include file='themes/TechBlue/include/MySugar/tpls/actions_menu.tpl'}
            </li>
        {/if}
    </ul>
    ...
    <div class="tab-content">
        {foreach from=$dashboardPages key=tabNum item=tab}
            ...
            {/if}
                <img src="themes/TechBlue/images/loading.gif" width="48" height="48" align="baseline" border="0" alt="">
            </div>
        {/foreach}
    </div>
</div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" id="dashletsList">
                    <p><img src="themes/TechBlue/images/loading.gif" width="48" height="48" align="baseline" border="0" alt=""></p>
                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><img src="themes/TechBlue/images/loading.gif" width="48" height="48" align="baseline" border="0" alt=""></p>                </div>
...
<script type="text/javascript" src="themes/TechBlue/include/MySugar/javascript/AddRemoveDashboardPages.js"></script>
<script type="text/javascript" src="themes/TechBlue/include/MySugar/javascript/retrievePage.js"></script>
